...
interface EmployeeDataFormatTypes{
  first_name : string 
  last_name : string 
  email : string
  dob: string 
...
interface RelationsFormatTypes{
  designation : string
  department : string
  batch : string
  joining_date : string
...
const Profile : React.FC= () => {
  const [employeeData, setEmployeeData] = useState<EmployeeDataFormatTypes | undefined>(undefined);
  const [relationsData, setRelationsData] = useState<RelationsFormatTypes | undefined>(undefined);
  const [documentsData, setDocumentsData] = useState<DocumentsFormatTypes | undefined>(undefined);
  ...
  const handleProfilePicSubmit = async (
    values : ProfileFormatter,
    { setSubmitting, setErrors } : FormikHelpers<ProfileFormatter>
  ) => {
