...
import EmployeeAttendance from '../component/Admin/pages/EmployeeAttendance';
import AllAttendance from '../component/Admin/pages/AllAttendance';
  ...
  createRoutesFromElements(
    <>
      ...
      <Route path="/dashboard"  element={<AdminRootLayout />}>
          ...
          <Route path="/dashboard/updateAttendance" element={<Committee />} />
          ...
          <Route path="/dashboard/attendance" element={<AllAttendance/>}/>       
          <Route path="/dashboard/profile" element={<AdminProfile />} />
          <Route path="/dashboard/profile/edit" element={< EditProfile/>} />
          <Route path="/dashboard/change-password" element={<ChangePassword />} />
          <Route path="/dashboard/attendance/:userId" element={<EmployeeAttendance/>}/>       
          ...
          <Route path="/dashboard/comments" element={<AdminChat/>} />   
